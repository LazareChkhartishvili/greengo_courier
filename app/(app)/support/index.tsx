  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        {/* Title */}
        <Text style={styles.title}>მხარდაჭერა</Text>

        {/* Menu Options */}
        <View style={styles.menuList}>
          <TouchableOpacity
            style={styles.menuItem}
            onPress={() => router.push("/(app)/support/order-questions")}
          >
          ...
          <TouchableOpacity
            style={styles.menuItem}
            onPress={() => router.push("/(app)/support/account-data")}
          >
            <Text style={styles.menuText}>ანგარიში და მონაცემები</Text>
            <Ionicons
              name="chevron-forward"
              size={20}
              color={Colors.gray.medium}
          ...
          <TouchableOpacity
            style={styles.menuItem}
            onPress={() => router.push("/(app)/support/payments")}
          >
            <Text style={styles.menuText}>გადახდები და ფასები</Text>
            <Ionicons
              name="chevron-forward"
              size={20}
              color={Colors.gray.medium}
          ...
          <TouchableOpacity
            style={styles.menuItem}
            onPress={() => router.push("/(app)/support/app-usage")}
          >
            <Text style={styles.menuText}>GreenGo-ს გამოყენება</Text>
            <Ionicons
              name="chevron-forward"
              size={20}
              color={Colors.gray.medium}
          ...
          >
            <Text style={styles.menuText}>სხვა</Text>
            <Ionicons
              name="chevron-forward"
              size={20}
              color={Colors.gray.medium}
