...
export default function DeleteAccountSupportScreen() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        <Text style={styles.title}>მსურს ჩემი ანგარიშის წაშლა</Text>

        <Text style={styles.description}>
          თუ გსურთ თქვენი ანგარიშის წაშლა, გთხოვთ დაუკავშირდეთ ჩვენს
          მხარდაჭერის გუნდს თქვენი დადასტურებული ელ.ფოსტის მისამართიდან.
        </Text>

        <Text style={styles.description}>
          გთხოვთ, მიუთითოთ თქვენი ანგარიშის წაშლის მიზეზი, რათა ჩვენ შევძლოთ
          თქვენი გამოცდილების გაუმჯობესება.
        </Text>

        <Text style={styles.description}>
          გთხოვთ, გაითვალისწინოთ, რომ ანგარიშის წაშლის შემდეგ, ყველა თქვენი
          მონაცემი გაუქმდება და აღდგენა შეუძლებელი იქნება.
        </Text>
