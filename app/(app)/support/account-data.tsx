      ...
      <View style={styles.content}>
        ...
        <View style={styles.menuList}>
          <TouchableOpacity
            ...
            onPress={() => router.push("/(app)/support/personal-info")}
          >
          ...
          <TouchableOpacity
            style={styles.menuItem}
            onPress={() => router.push("/(app)/support/account-blocked")}
          >
          ...
          <TouchableOpacity
            style={styles.menuItem}
            onPress={() => router.push("/(app)/support/unsubscribe")}
          >
            <Text style={styles.menuText}>
          ...
          <TouchableOpacity
            style={styles.menuItem}
            onPress={() => router.push("/(app)/support/delete-account")}
          >
