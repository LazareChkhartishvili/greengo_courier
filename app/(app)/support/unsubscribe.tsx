...
export default function UnsubscribeEmailScreen() {
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        <Text style={styles.title}>
          მსურს ელ.ფოსტაზე გამოწერის გაუქმება
        </Text>

        <Text style={styles.description}>
          bolt food-ის სიახლეების გამოწერით, თქვენ იღებთ ინფორმაციას, ფასების,
          მიმდინარე აქციებისა და უახლესი პროდუქტების შესახებ.
        </Text>

        <Text style={styles.description}>
          თუ თქვენ არ გსურთ ამ შეტყობინებების მიღება, შეგიძლიათ გამოწერის
          გაუქმება:
        </Text>

        <View style={styles.bulletList}>
          <Text style={styles.bulletItem}>• დააჭირეთ პროფილის სიმბოლოს</Text>
          <Text style={styles.bulletItem}>• აირჩიეთ პარამეტრები</Text>
          <Text style={styles.bulletItem}>
            • შეცვალეთ კომუნიკაციის პრეფერენციები
          </Text>
        </View>

        <Text style={styles.description}>
          თუ პრეფერენციების შეცვლის შემდეგ, ისევ იღებთ სიახლეებს, გამოიყენეთ,
          შეტყობინების ბოლოში მოცემული, გამოწერის გაუქმების ღილაკი და მიჰყევით
          ინსტრუქციას.
        </Text>
        ...
        <View style={styles.questionContainer}>
          ...
          <View style={styles.buttonsContainer}>
            ...
            >
              <Ionicons
                name={
                  isHelpful === true ? "checkmark-circle" : "thumbs-up-outline"
                }
                size={20}
            ...
            >
              <Ionicons
                name={
                  isHelpful === false ? "checkmark-circle" : "heart-outline"
                }
                size={20}
